...
typedef struct cisml_match_it CISML_MATCH_IT_T;
typedef struct multi_pattern MULTI_PATTERN_T;
typedef struct multi_pattern_match MULTI_PATTERN_MATCH_T;
...
/*************************************************************************
 * Calculate the q-values from the p-values of the multi-patterns
 *************************************************************************/
...
/**********************************************************************
  ...
  Gets the pvalue member from a cisml multi_pattern_match object.
**********************************************************************/
double get_multi_pattern_match_pvalue(MULTI_PATTERN_MATCH_T* match);
...
/**********************************************************************
  get_pattern_matched_elements

  Gets the array of matched_element objects contained in a cisml
  pattern object.
**********************************************************************/
